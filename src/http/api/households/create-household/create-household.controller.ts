...
import { CreateHouseholdBody, type HouseholdView, HouseholdView as HouseholdViewSchema } from "../households.schema.js";
...
export const createHouseholdRoute: FastifyPluginAsync = async (app) => {
