...
import { createPreviewService } from "../import.service.js";
import { createImportsRepository } from "../imports.repository.js";
import { PreviewImportBody, PreviewImportResponse } from "../imports.schema.js";

// Previewing a statement/receipt is an `adult`-level action. The Deepseek gateway is
// pulled from the request (so tests inject a fake); categorization is best-effort.
export const previewImportRoute: FastifyPluginAsync = async (app) => {
